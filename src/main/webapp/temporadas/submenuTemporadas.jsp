			...
			<div class="col-md-6 d-flex justify-content-center">
				<div class="card m-2 cb1 text-center">
  					<div class="card-body">
    					...
    					<h2 class="card-title mb-4">Registrar Temporada</h2>
    					<p class="card-text">Ingresa los datos para registrar una temporada</p>
    					<a href='<s:url namespace="/temporadas" action="formularioRegistroTemporada" />' class="btn btn-outline-light">Registrar</a>
  					</div>
				</div>
			</div>
			...
			<div class="col-md-6 d-flex justify-content-center">
				<div class="card m-2 cb2 text-center">
  					<div class="card-body">
    					...
    					<h2 class="card-title mb-4">Consultar temporadas</h2>
    					<p class="card-text">Consulta las temporadas registradas en el sistema</p>
    					<a href='<s:url namespace="/temporadas" action="consultarTemporadas" />' class="btn btn-outline-light">Consultar</a>
  					</div>
				</div>
			</div>
